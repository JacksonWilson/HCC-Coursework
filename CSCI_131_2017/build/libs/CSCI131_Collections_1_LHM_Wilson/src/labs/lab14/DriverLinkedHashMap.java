...
public class DriverLinkedHashMap {

    public static void main(String[] args) {
        try {
            LinkedHashMap<String, DataSet> disciplines = getDisciplines("reg_in.txt");
    ...
    private static LinkedHashMap<String, DataSet> getDisciplines(String path) throws IOException {
        LinkedHashMap<String, DataSet> disciplines = new LinkedHashMap<>();
